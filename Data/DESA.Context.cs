...
namespace Data
{
    ...
    public partial class DESA : DbContext
    {
        ...
        public virtual int SP_Delete_Direccion_Usuario1(Nullable<int> userCode, Nullable<int> direccionCode)
        {
            var userCodeParameter = userCode.HasValue ?
                new ObjectParameter("UserCode", userCode) :
                new ObjectParameter("UserCode", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SP_Delete_Direccion_Usuario1", userCodeParameter, direccionCodeParameter);
        }
        ...
        public virtual ObjectResult<SP_Get_Domicilio_Usuario_byUserID_Result> SP_Get_Domicilio_Usuario_byUserID(Nullable<int> userCode)
        {
            var userCodeParameter = userCode.HasValue ?
                new ObjectParameter("UserCode", userCode) :
                new ObjectParameter("UserCode", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_Get_Domicilio_Usuario_byUserID_Result>("SP_Get_Domicilio_Usuario_byUserID", userCodeParameter);
        }
    
        public virtual ObjectResult<SP_Get_Domicilio_Cliente_byClienteID_Result> SP_Get_Domicilio_Cliente_byClienteID(Nullable<int> clienteCode)
        {
            var clienteCodeParameter = clienteCode.HasValue ?
                new ObjectParameter("ClienteCode", clienteCode) :
                new ObjectParameter("ClienteCode", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_Get_Domicilio_Cliente_byClienteID_Result>("SP_Get_Domicilio_Cliente_byClienteID", clienteCodeParameter);
        }
    
        public virtual ObjectResult<SP_Get_Domicilio_Proveedor_byProveedorID_Result> SP_Get_Domicilio_Proveedor_byProveedorID(Nullable<int> proveedorCode)
        {
            var proveedorCodeParameter = proveedorCode.HasValue ?
                new ObjectParameter("ProveedorCode", proveedorCode) :
                new ObjectParameter("ProveedorCode", typeof(int));
